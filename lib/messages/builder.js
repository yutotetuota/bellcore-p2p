...
function builder(options) {
  ...
  if (!options.network) {
    options.network = vertcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || vertcore.Block;
  options.BlockHeader = options.BlockHeader || vertcore.BlockHeader;
  options.Transaction = options.Transaction || vertcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || vertcore.MerkleBlock;
